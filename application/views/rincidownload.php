            ...
            <div class="left_col">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <p class="alert alert-warning"><?php echo $row->kategori1 ?></p>
                      
                        <?php foreach($this->MDownload->showrinci($row->idjenis) as $row2) { ?>
                       
                        <div>
                            <row>
                                <div class="col-md-8">
                                <p><em class="	fa fa-download">&nbsp;&nbsp;</em><?php echo $row2->deskripsi ?></p>
                                </div>
                                <div class="col-md-4">
                                <a href="<?php echo base_url().'upload/file/'. $row2->namafile; ?>" download>Download</a>
                                </div>
