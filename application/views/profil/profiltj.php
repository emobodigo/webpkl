...
?>
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12" style="height:180px;">
                                    <?php foreach ($div3 as $row){ ?>
                        <?php
$image = !empty($row->foto1) ? $row->foto1 : "/images/default.png";
?>
                                    <a href="<?php echo site_url("berita/showBerita/") ?><?php echo $row->iddata ?>" class="gtco-item one-row bg-img animate-box img-rounded" style="background-image: url(<?php echo base_url('upload/'. $image) ?>); background-repeat:no-repeat; height:170px; width:340px; background-position:center; margin-bottom:0.5em;">
                                        <div class="overlay">
                                            <i class="ti-arrow-top-right"></i>
                                            <div class="copy">
                                                <h3><?php echo $row->judul; ?></h3>
