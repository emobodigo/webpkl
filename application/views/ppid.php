                ...
                <div class="row">
                    ...
                    <div class="col-md-8 ">
                        ...
                        <div class="col-md-8 col-md-offset-2">
                            <a href="<?php echo site_url('welcome/linked') ?>"><button  type="button" class="btn btn-info btn-block">Daftar Informasi Berkala</button></a>
                            <a href="<?php echo site_url('Berita/') ?>"><button  type="button" class="btn btn-info btn-block">Berita Informasi Serta Merta</button></a>
                        </div>
                        </div>
