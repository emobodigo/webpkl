                ...
                <div class="row">
                    ...
                    <div class="col-md-8 ">
                        ...
                        <div class="col-md-8 col-md-offset-2">
                            <a href="<?php echo site_url('welcome/nav/') ?><?php echo 53 ?>"><button  type="button" class="btn btn-info btn-block">Struktur Organisasi</button></a>
                            <a href="<?php echo site_url('welcome/nav/') ?><?php echo 28 ?>"><button  type="button" class="btn btn-info btn-block">Sistem Akuntabilitas Kinerja Instansi Pemerintah</button></a>
                        </div>
                        </div>
