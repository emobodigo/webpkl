    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <?php echo  form_open_multipart('user/addUser'); ?>
            ...
            <div class="form-group">
                ...
                <input  name="username" required="required" style="height:35px; width:400px;" type="text" class="form-control" aria-describedby="emailHelp" placeholder="Enter Username">
            </div>
            <div class="form-group">
                <label for="judul">Password</label>
                <input  name="passwd" required="required" style="height:35px; width:400px;" type="password" class="form-control">
            </div>
            <div class="form-group">
                <label for="judul">Nama</label>
                <input  name="nama" required="required" style="height:35px; width:400px;" type="text" class="form-control">
            </div>
            <div class="form-group">
                <label for="judul">Email</label>
                <input  name="email"  style="height:35px; width:400px;" type="text" class="form-control">
            </div>
            <div class="form-group">
