...
<body>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <!--/.row-->
        <?php echo  form_open_multipart('admin/UpdateSlideshow'); ?>
        ...
        foreach ($ambilid->result() as $row){
            ...
            <div class="form-group">
                ...
                <input value="<?php echo $row->caption ?>" name="caption" required="required" style="height:35px; width:400px;" type="text" class="form-control" aria-describedby="emailHelp" placeholder="Enter Caption">
            </div>
            <div class="form-group">
