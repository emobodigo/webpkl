...
<body>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <div class="row">
            ...
            <div class="col-lg-1">
                <a href="<?php echo site_url('pageadmin/showAddPage') ?>" class="btn btn-success page-header"><i class="fa fa-plus"></i></a>
            </div>
        </div>
        <!--/.row-->
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        ...
                        <a href="<?php echo site_url("pageadmin/showEditPage/") ?><?php echo $row->idhal; ?>" class="fa fa-edit" style="padding:2px 2px;"></a> 
                    </td>
                    <td>
                        <?php echo anchor('pageadmin/deleteMenus/'. $row->idmenu, '<i class="fa fa-trash"></i>' , array('onclick' => "return confirm('yakin ingin menghapus item ini?');"));?>
                    </td>
                </tr>
                <?php endforeach; ?>
                <?php else: ?>
