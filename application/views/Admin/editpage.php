...
<body>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <!--/.row-->
        <?php echo  form_open_multipart('pageadmin/updatePage'); ?>
        ...
        foreach ($ambilid->result() as $row){
            ...
            <div class="form-group">
                ...
                <input type="hidden" name="idhal" value="<?php echo $row->idhal ?>">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" name="editor1" name="detail" id="editor1" rows="10" cols="80"><?php echo $row->detail ?></textarea>
            </div>
            <div class="form-group">
