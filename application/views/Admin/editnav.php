    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        <div class="row">
            <ol class="breadcrumb">
                ...
                <li class="active">Edit Navigasi</li>
            </ol>
        </div>
        <!--/.row-->
            ...
            <?php echo form_open_multipart('pageadmin/updateNav'); ?>
          <?php
        ...
        <div class="form-group">
            <input type="hidden" name="idmenu" value="<?php echo $row->idmenu ?>">
             <?php }} ?>
                ...
                <select name="parent" class="form-control" style="height:35px; width:400px;" id="sel1">
                    <option disabled selected value> -- select a Parent -- </option>
                    <option value="0"> No Parent Single </option>
                    <option value="99"> No Parent With Sub </option>
                    <?php foreach($menu as $row){ ?>
                   <option value="<?php echo $row->idmenu ?>"><?php echo $row->menu ?></option>
                     <?php } ?>
                </select>
