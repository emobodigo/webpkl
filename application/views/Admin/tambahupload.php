    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <?php echo  form_open_multipart('admin/upload'); ?>
            ...
            <div class="form-group">
                ...
                <input name="deskripsi" required="required" style="height:35px; width:400px;" type="text" class="form-control" aria-describedby="emailHelp" placeholder="Enter Deskripsi">
            </div>
            <div class="form-group">
